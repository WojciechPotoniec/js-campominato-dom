...
// funzione per generare un numero random compreso tra un minimo e un massimo e che viene associato ad un array vuoto
function getRndmNumberUnique(min, max, list){
    let isFound = false;
    let randomNum;

    while(isFound === false){
        randomNum = getRndInteger(min, max);
